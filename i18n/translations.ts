...
export const translations = {
  en: {
    ...
    // Username Modal
    welcomeTitle: 'Welcome to Phoenix Music Maker',
    ...
    poweredBy: 'Powered by Phoenix Music Maker. Open source and free to use.',
    createdBy: 'Created by babyUFO',
    ...
    emailBody: 'Hey!\n\nI created this AI-generated song and thought you\'d love it:\n\n"{title}" by {creator}\n{style}\n\nListen here: {url}\n\nMade with Phoenix Music Maker - free and open source local AI music generation!',
  ...
  zh: {
    ...
    // Username Modal
    welcomeTitle: '欢迎使用 Phoenix Music Maker',
    ...
    poweredBy: '由 Phoenix Music Maker 驱动。开源免费使用。',
    createdBy: '开发者 babyUFO',
    ...
    emailBody: '嘿！\n\n我创作了这首AI生成的歌曲，觉得你会喜欢：\n\n《{title}》- {creator}\n{style}\n\n点击收听：{url}\n\n使用 Phoenix Music Maker 制作 - 免费开源的本地AI音乐生成工具！',
  ...
  ja: {
    ...
    // Username Modal
    welcomeTitle: 'Phoenix Music Makerへようこそ',
    ...
    poweredBy: 'Phoenix Music Maker を搭載。オープンソースで無料で使用できます。',
    createdBy: '開発者 babyUFO',
    ...
    emailBody: 'こんにちは！\n\n私がこのAI生成の曲を作りました。気に入ってもらえると思います：\n\n「{title}」by {creator}\n{style}\n\nここで聴いてください：{url}\n\nPhoenix Music Makerで作成 - 無料でオープンソースのローカルAI音楽生成！',
  ...
  ko: {
    ...
    // Username Modal
    welcomeTitle: 'Phoenix Music Maker에 오신 것을 환영합니다',
    ...
    poweredBy: 'Phoenix Music Maker 기반. 오픈 소스이며 무료로 사용 가능합니다.',
    createdBy: '개발자 babyUFO',
    ...
    emailBody: '안녕하세요!\n\n제가 만든 이 AI 생성 곡을 들어보세요. 마음에 드실 거예요:\n\n"{title}" - {creator}\n{style}\n\n여기서 들으세요: {url}\n\nPhoenix Music Maker로 제작 - 무료 오픈 소스 로컬 AI 음악 생성!',
