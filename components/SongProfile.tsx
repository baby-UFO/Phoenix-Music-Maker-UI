...
const updateMetaTags = (song: Song) => {
    ...
    const title = `${song.title} by ${song.creator || 'Unknown Artist'} | Phoenix Music Maker`;
    const description = `Listen to "${song.title}" - ${song.style}. ${song.viewCount || 0} plays, ${song.likeCount || 0} likes. Create your own AI music with Phoenix Music Maker.`;
...
const resetMetaTags = () => {
    document.title = 'Phoenix Music Maker - Local AI Music Generator';
    const defaultDescription = 'Create original music with AI locally. Generate songs in any style with custom lyrics and professional quality using Phoenix Engine.';
    ...
    updateMeta('meta[property="og:title"]', 'Phoenix Music Maker - Local AI Music Generator');
    ...
    updateMeta('meta[name="twitter:title"]', 'Phoenix Music Maker - Local AI Music Generator');
